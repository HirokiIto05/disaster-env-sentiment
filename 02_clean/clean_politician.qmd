...
```{python}
src_historical = here("01_data/raw/us_congress/legislators-historical.json")
src_current = here("01_data/raw/us_congress/legislators-current.json")
...
df_raw = pl.concat([df_historical, df_current_aligned], how="vertical")
